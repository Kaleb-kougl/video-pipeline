...
async def main():
    ...
    Example:
        python main_refactored.py process-episode "My Hero Academia" 1 1 --full
        python main_refactored.py create-season-summary "My Hero Academia" 1 --duration 10
        python main_refactored.py analyze-season "My Hero Academia" 1
    """
    setup_logging()
