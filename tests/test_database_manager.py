...
class TestDatabaseManager:
    ...
    def test_save_and_get_episode(self, temp_db):
        ...
        result = db.get_episode(test_data["show"], test_data["season"], test_data["episode"])
    ...
    def test_sqlite_row_access_patterns(self, temp_db):
        ...
        # Save test data
        db.save_episode(
            "Test Show", "1", "1", "https://test.com", "Test transcript", "Test summary", ["plot1"]
        )
    ...
    def test_episode_data_none_handling(self, temp_db):
        ...
        db.save_episode("Test Show", "1", "2", "https://test.com", None, None, None)
