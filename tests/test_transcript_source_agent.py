            ...
            if sources:
                ...
                if evaluation.get('accessible', False):
                    ...
                    if content_analysis:
                        ...
                        print(f"  Content Density: {content_analysis.get('content_density', 0):.2f}")
...
if __name__ == "__main__":
    ...
    print("python main_refactored.py discover-sources 'My Hero Academia' --season 1")
    print("python main_refactored.py recommend-sources 'My Hero Academia'")
    print("python main_refactored.py evaluate-source 'https://example.com' 'My Hero Academia'")
