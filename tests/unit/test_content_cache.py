...
class TestContentCache:
    ...
    def test_cache_text_content_success(self, content_cache, sample_text_content):
        ...
        content_hash = content_cache._generate_content_hash(sample_text_content, ContentType.TEXT)

        # Cache the content
        result = content_cache.cache_content(content_hash, sample_text_content, ContentType.TEXT)
    ...
    def test_cache_image_content_success(self, content_cache, sample_image_data):
        ...
        content_hash = content_cache._generate_content_hash(sample_image_data, ContentType.IMAGE)

        # Cache the image data
        result = content_cache.cache_content(content_hash, sample_image_data, ContentType.IMAGE)
    ...
    def test_retrieve_cached_content_miss(self, content_cache):
        ...
        retrieved = content_cache.get_cached_content(non_existent_hash, ContentType.TEXT)
    ...
    def test_content_similarity_detection(
        self, content_cache, sample_text_content, similar_text_content
    ):
        """Test similarity detection between similar content."""
        # Cache original content
        original_hash = content_cache._generate_content_hash(sample_text_content, ContentType.TEXT)
        content_cache.cache_content(original_hash, sample_text_content, ContentType.TEXT)

        # Check for similar content
        similar_content = content_cache.find_similar_content(similar_text_content, ContentType.TEXT)
    ...
    def test_content_similarity_below_threshold(self, content_cache, sample_text_content):
        ...
        similar_content = content_cache.find_similar_content(dissimilar_content, ContentType.TEXT)
...
class TestCacheConfig:
    ...
    def test_custom_config_values(self):
        ...
        config = CacheConfig(max_content_entries=50, similarity_threshold=0.9, ttl_hours=12)
...
class TestCacheIntegration:
    ...
    def test_cache_integration_with_image_generation(self, fake_image_generator):
        ...
        result2 = content_cache.get_or_generate_image(
            ...
            episode_context="S1E1",  # Same context should hit cache
        )
    ...
    def test_cache_with_character_enhancement_integration(self):
        ...
        content_cache = ContentCache()
        character_data = {"name": "Naruto", "importance": 0.9, "screen_time": 0.8}
    ...
    def test_cache_memory_constraints(self):
        ...
        small_config = CacheConfig(max_content_entries=5, max_image_entries=3)
