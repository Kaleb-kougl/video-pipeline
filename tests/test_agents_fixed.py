...
def test_episode_discovery_agent():
    ...
    try:
        ...
        print(
            f"✅ discover_episode_url('My Hero Academia', 1, 4, ['Start Line']) = {discovered_url}"
        )
...
def test_all_agents_quick():
    ...
    try:
        ...
        QualityCoordinator()
        print("  ✅ QualityCoordinator initialization successful")
...
def test_cli_commands():
    ...
    try:
        result = subprocess.run(
            [sys.executable, "main.py", "--help"], capture_output=True, text=True, timeout=10
        )
