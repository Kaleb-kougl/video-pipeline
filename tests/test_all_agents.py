...
class AgentValidator:
    ...
    def test_agent_initialization(
        self, agent_class, agent_name: str, init_params: dict = None
    ) -> Any | None:
    ...
    def test_agent_basic_functionality(self, agent, agent_name: str, test_methods: list) -> bool:
        ...
        logger.info(
            f"📊 {agent_name} functionality test: {success_count}/{total_methods} methods passed ({success_rate:.1%})"
        )
    ...
    def validate_transcript_discovery_agent(self) -> dict:
        ...
        functionality_ok = self.test_agent_basic_functionality(
            agent, "TranscriptDiscoveryAgent", test_methods
        )
    ...
    def validate_transcript_source_agent(self) -> dict:
        ...
        agent = self.test_agent_initialization(
            TranscriptSourceDiscoveryAgent, "TranscriptSourceDiscoveryAgent"
        )
        ...
        functionality_ok = self.test_agent_basic_functionality(
            agent, "TranscriptSourceDiscoveryAgent", test_methods
        )
    ...
    def validate_content_agent(self) -> dict:
        ...
        try:
            ...
            agent = self.test_agent_initialization(
                ContentAgent, "ContentAgent", {"model": MockModel()}
            )
    ...
    def validate_quality_agent(self) -> dict:
        ...
        functionality_ok = self.test_agent_basic_functionality(
            agent, "QualityAssuranceAgent", test_methods
        )
    ...
    def validate_discovery_agent(self) -> dict:
        ...
        functionality_ok = self.test_agent_basic_functionality(
            agent, "EpisodeDiscoveryAgent", test_methods
        )
    ...
    def validate_config_manager(self) -> dict:
        ...
        functionality_ok = self.test_agent_basic_functionality(
            agent, "EpisodeConfigManager", test_methods
        )
    ...
    def validate_workflow_orchestrator(self) -> dict:
        ...
        try:
            ...
            logger.warning(
                f"⚠️ WorkflowOrchestrator initialization failed, trying with custom db path: {e}"
            )
            agent = self.test_agent_initialization(
                WorkflowOrchestrator, "WorkflowOrchestrator", {"db_path": ":memory:"}
            )
