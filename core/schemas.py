...
class EpisodeConfig(BaseModel):
    ...
    title: Optional[str] = Field(description="Episode title", default=None)
    max_episodes: Optional[int] = Field(description="Maximum episodes in season", default=None)
...
class TranscriptResult(BaseModel):
    ...
    found_via_search: bool = Field(description="Whether found via search or URL patterns", default=False)
...
class ProcessingResult(BaseModel):
    ...
    job_id: Optional[str] = Field(description="Job identifier", default=None)
    data: Optional[dict] = Field(description="Processed episode data", default=None)
    error: Optional[str] = Field(description="Error message if failed", default=None)
    source_info: Optional[TranscriptResult] = Field(description="Information about transcript source", default=None)
